...
import {
  ...
  shallowRef,
  watch
} from "./chunk-EEY5NECJ.js";
import "./chunk-QLU32RQJ.js";

// node_modules/@intlify/core-base/node_modules/@intlify/shared/dist/shared.js
...
// node_modules/@intlify/core-base/node_modules/@intlify/message-compiler/dist/message-compiler.js
...
// node_modules/vue-i18n/node_modules/@intlify/shared/dist/shared.js
...
// node_modules/@intlify/vue-i18n-core/node_modules/@intlify/shared/dist/shared.js
var inBrowser3 = typeof window !== "undefined";
var mark3;
var measure3;
if (true) {
  const perf = inBrowser3 && window.performance;
  if (perf && perf.mark && perf.measure && perf.clearMarks && perf.clearMeasures) {
    mark3 = (tag) => {
      perf.mark(tag);
    };
    measure3 = (name, startTag, endTag) => {
      perf.measure(name, startTag, endTag);
      perf.clearMarks(startTag);
      perf.clearMarks(endTag);
    };
...
var _create3 = Object.create;
var create3 = (obj = null) => _create3(obj);
var _globalThis3;
var getGlobalThis3 = () => {
  return _globalThis3 || (_globalThis3 = typeof globalThis !== "undefined" ? globalThis : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : typeof global !== "undefined" ? global : create3());
};
  ...
  while (stack.length) {
    ...
    Object.keys(src2).forEach((key) => {
      ...
      if (isObject2(src2[key]) && !isObject2(des2[key])) {
        des2[key] = Array.isArray(src2[key]) ? [] : create3();
      }
...
function initFeatureFlags2() {
  if (false) {
    getGlobalThis3().__VUE_I18N_FULL_INSTALL__ = true;
  }
  if (typeof __INTLIFY_DROP_MESSAGE_COMPILER__ !== "boolean") {
    getGlobalThis3().__INTLIFY_DROP_MESSAGE_COMPILER__ = false;
  }
  if (false) {
    getGlobalThis3().__INTLIFY_PROD_DEVTOOLS__ = false;
  }
}
function initDev() {
}
...
function getLocaleMessages(locale, options) {
  ...
  const ret = isPlainObject2(messages) ? messages : isArray3(__i18n) ? create3() : { [locale]: create3() };
  if (isArray3(__i18n)) {
    __i18n.forEach((custom) => {
      if ("locale" in custom && "resource" in custom) {
        const { locale: locale2, resource } = custom;
        if (locale2) {
          ret[locale2] = ret[locale2] || create3();
          deepCopy2(resource, ret[locale2]);
        } else {
          deepCopy2(resource, ret);
        }
      } else {
        isString2(custom) && deepCopy2(JSON.parse(custom), ret);
      }
    });
  }
...
function adjustI18nResources(gl, options, componentOptions) {
  let messages = isObject2(options.messages) ? options.messages : create3();
...
function createComposer(options = {}) {
  ...
  const _ref = inBrowser3 ? ref : shallowRef;
  ...
  const _fallbackLocale = _ref(
    __root && _inheritLocale ? __root.fallbackLocale.value : isString2(options.fallbackLocale) || isArray3(options.fallbackLocale) || isPlainObject2(options.fallbackLocale) || options.fallbackLocale === false ? options.fallbackLocale : _locale.value
  );
  ...
  const wrapWithDeps = (fn, argumentParser, warnType, fallbackSuccess, fallbackFail, successCondition) => {
    ...
    if (warnType !== "translate exists" && isNumber2(ret) && ret === NOT_RESOLVED || warnType === "translate exists" && !ret) {
  ...
  function d(...args) {
    return wrapWithDeps((context) => Reflect.apply(datetime, null, [context, ...args]), () => parseDateTimeArgs(...args), "datetime format", (root) => Reflect.apply(root.d, root, [...args]), () => MISSING_RESOLVE_VALUE, (val) => isString2(val) || isArray3(val));
  }
  function n(...args) {
    return wrapWithDeps((context) => Reflect.apply(number, null, [context, ...args]), () => parseNumberArgs(...args), "number format", (root) => Reflect.apply(root.n, root, [...args]), () => MISSING_RESOLVE_VALUE, (val) => isString2(val) || isArray3(val));
  }
  ...
  function translateVNode(...args) {
    return wrapWithDeps((context) => {
      ...
      return ret;
    }, () => parseTranslateArgs(...args), "translate", (root) => root[TranslateVNodeSymbol](...args), (key) => [createTextNode(key)], (val) => isArray3(val));
  }
  function numberParts(...args) {
    return wrapWithDeps((context) => Reflect.apply(number, null, [context, ...args]), () => parseNumberArgs(...args), "number format", (root) => root[NumberPartsSymbol](...args), NOOP_RETURN_ARRAY, (val) => isString2(val) || isArray3(val));
  }
  function datetimeParts(...args) {
    return wrapWithDeps((context) => Reflect.apply(datetime, null, [context, ...args]), () => parseDateTimeArgs(...args), "datetime format", (root) => root[DatetimePartsSymbol](...args), NOOP_RETURN_ARRAY, (val) => isString2(val) || isArray3(val));
  }
  ...
  function mergeLocaleMessage(locale2, message) {
    ...
    message = _message[locale2];
    deepCopy2(message, _messages.value[locale2]);
    _context.messages = _messages.value;
  }
...
function editScope(payload, i18n) {
  ...
  if (composer) {
    ...
    } else if (field === "fallbackLocale" && (isString2(payload.state.value) || isArray3(payload.state.value) || isObject2(payload.state.value))) {
...
function isVNode(target) {
  return isArray3(target) && !isString2(target[0]);
}
function renderFormatter(props, context, slotKeys, partFormatter) {
  const { slots, attrs } = context;
  return () => {
    const options = { part: true };
    let overrides = create3();
    if (props.locale) {
    ...
    if (isString2(props.format)) {
      ...
      overrides = Object.keys(props.format).reduce((options2, prop) => {
        return slotKeys.includes(prop) ? assign2(create3(), options2, { [prop]: props.format[prop] }) : options2;
      }, create3());
    }
    ...
    const assignedAttrs = assign2(create3(), attrs);
